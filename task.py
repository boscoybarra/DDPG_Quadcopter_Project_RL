...
class TakeOff_Task():
    ...
    def get_reward(self):
        ...
        # Copyright: This implementation was implemented by parkitny.
        # For more info visit: https://github.com/parkitny
        ...
        # optimal_reward = (abs(math.sin(self.sim.pose[3] - 1.)))
        # optimal_reward *= (abs(math.sin(self.sim.pose[4] - 1.)))
        # optimal_reward *= (abs(math.sin(self.sim.pose[5] - 1.)))
        ...
        # if(r > 0.1): decay = math.exp(-1/r) # Give range -1 to 1
        # else: decay = 0
        # reward = 1. - decay
...
class Land_Task():
    ...
    def get_reward(self):
        ...
        # Copyright: This is a modified implementation by parkitny.
        # For more info visit: https://github.com/parkitny
        # Keep the Euler angles stable plotting them in a sin funtion
        # Multiply each angle and store, we want them to be between -1 and 1.
        # optimal_reward = (abs(math.sin(self.sim.pose[3] - 1.)))
